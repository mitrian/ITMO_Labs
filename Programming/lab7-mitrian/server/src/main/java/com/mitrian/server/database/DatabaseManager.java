...
public class DatabaseManager {
    ...
    private static DBConnectionManagerImpl databaseConnectionManager;

    public DatabaseManager(DBConnectionManagerImpl databaseConnectionManager) {
        DatabaseManager.databaseConnectionManager = databaseConnectionManager;
    }

    public int insertElement(Worker worker) throws SQLException {
        Connection connection = databaseConnectionManager.getConnection();
        try (connection){
            connection.setAutoCommit(false);
            int workerId = insertElement((Worker) connection);
            connection.commit();
    ...
    public static boolean updateWorker(int id, String name, Coordinates coordinates, int salary,
                                       ZonedDateTime startDate, Date endDate, Status status,
