...
public final class ResponseMapper {
	 ...
	 */
	public byte[] mapFromInstanceToBytes(AbstractResponse abstractResponse) throws MappingException {
		try {
			return SerializationUtils.serialize(abstractResponse);
		}
	...
	public <T extends AbstractResponse> T mapFromBytesToInstance(byte[] bytes) throws MappingException {
		try {
