...
public class MinByNameCommand extends AbstractCommand {
    ...
    public MinByNameCommand(Printer printer, CommandSource source, List<String> arguments, boolean inputElement, Dao<Worker> dao) {
    ...
    public boolean execute() throws CollectionException {
        printer.print(dao.getMinByName().toString());
        return true;
    }
}
