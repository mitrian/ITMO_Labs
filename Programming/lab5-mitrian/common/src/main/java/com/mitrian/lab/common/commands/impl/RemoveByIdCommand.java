...
public class RemoveByIdCommand extends AbstractCommand {
    ...
    public RemoveByIdCommand(Printer printer, CommandSource source, List<String> arguments, boolean inputElement, Dao<Worker> dao) {
    ...
    public boolean execute() {
       // dao.remove(ConsoleArgumentParser);
        return true;
    }
}
